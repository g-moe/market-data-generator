...
export const DATA_TEMP_ROOT = 'data-temp';
...
export const SIERRA_BRIDGE_PDB_FILE_NAME = 'tradester_sync_bridge_ARM64.pdb';
...
export type SierraTimeframe = (typeof TIMEFRAMES)[number];
