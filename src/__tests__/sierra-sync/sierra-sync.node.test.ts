	...
	it('runs the Sierra sync steps in order with injected ops', async () => {
		await withProcessPlatform('win32', async () => {
			...
			expect(calls).toEqual([
				...
				'copyChartbook',
				'openSierra',
				'waitForFiles:tradester_ES_1d_GraphData.txt|tradester_ES_5m_GraphData.txt|tradester_ES_15s_GraphData.txt|tradester_ES_500v_GraphData.txt|tradester_ES_1s_pl0.25_GraphData.txt'
			]);
